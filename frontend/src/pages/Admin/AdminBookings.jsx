...
//           {bookings.length === 0 ? (
//             <p className="p-4 text-gray-500 text-sm">No bookings found</p>
//           ) : (
//             bookings.map((b) => (
//               <div
//                 key={b._id}
//                 className="p-4 flex flex-col md:flex-row md:justify-between md:items-center gap-3"
//               >
//                 {/* LEFT SIDE */}
//                 <div>
...
//                       <span className="font-medium">Project:</span> {b.notes}
//                     </p>
//                   )}
